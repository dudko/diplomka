        ...
        <div className="ui centered grid">
          <div className="eleven wide column">
            ...
            <p>
              ...
              </b>. The original method was derived by Grimsditch and Nizzoli
              for so-called superlattices - systems where atomic planes of one
            ...
            >
              ...
              <p>
                ...
                numbers. <br />In the case of eigenvalues, mechanical stability
                of a system with an arbitrary crystallographic symmetry is
                mathematically equivalent with the necessary and sufficient
                condition of all eigenvalues of the matrix of elastic constants
                being positive (see, e.g.,{' '}
                <a
