    ...
    <div className="ui centered grid">
      <div className="eleven wide column">
        ...
        <p>
          ...
          coordinate systems rotated (see the example below when the phase 1 is
          rotated):
          <img className="ui centered big image" src={figure2} alt="" />
          Considering the example in the figure immediately above, the input
          matrix of elastic constants of phase 1 must be transformed from the
          local rotated coordinate system of phase 1 into the global coordinate
          system. It is often so that the matrix of elastic constants is known
          only in the most <i>“natural”</i> coordinate system when the axes
          coincide with the main crystallographic directions (and the matrix is
          then particularly simple). MELASA computes the rotated matrix of
          elastic constants for the user considering two degrees of freedom
          defining the local rotated coordinate system. First, the user can
          specify the direction of z-axis of the local rotated system in the
          global coordinate system in the form of three Miller indices (in the
